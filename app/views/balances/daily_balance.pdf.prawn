...
pdf.text "Balance diario", :align => :center, :size => 20
pdf.table data, :headers            => ["Fecha", "Cantidad consultas", "Monto consultas", "Cantidad cirugías", "Monto cirugías", "Monto total"],
                :font_size          => 10,
                :vertical_padding   => 2,
