class ConsultationsController < ApplicationController
  ...
  active_scaffold :consultation do |conf|
    ...
    conf.list.columns = [:wight, :height, :head_circumference, :anterior_fontanel, :temperature, :current_condition, :diagnosis, :medical_certificate, :recipe, :order, :laboratory, :amount]
